...
\newfontfamily\russianfont[Script=Cyrillic]{Liberation Serif}
...
\newcommand\sender{Иванова Петра Сидоровича}
\newcommand\fromaddr{Страна Оз, г. Изумрудный, ул. Желтого камня, д. 1}
\newcommand\fromindx{987654}

\begin{document}
\thispagestyle{empty}

\fromtext{\sender}{\fromaddr}{\fromindx}
